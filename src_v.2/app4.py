...
def train_and_predict(Y_df, horizon, config, output_path, full_horizon, model_name):
    ...
    try:
        ...
        print("Aviso: Instale scikit-learn para validação cruzada.")
...
if __name__ == '__main__':
    ...
    if Y_df['ds'].min() > pd.to_datetime('2023-01-01') or Y_df['ds'].max() < pd.to_datetime('2023-12-31'):
        print("Aviso: Os dados não cobrem o intervalo esperado!")
