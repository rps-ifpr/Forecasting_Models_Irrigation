...
def predict_with_loaded_model(data_path, model_path, full_horizon, config):
    """Carrega um modelo treinado e faz previsões."""
...
if __name__ == '__main__':
    ...
    model_path = 'checkpoints/test_run/'
    full_horizon = 20
    config = {
    ...
    predict_with_loaded_model(data_path, model_path, full_horizon, config)